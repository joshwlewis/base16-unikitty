#!/usr/bin/env bash
# Base16 Unikitty Reversible - Gnome Terminal color scheme install script
...
gset string palette "#2e2a31:#d8137f:#17ad98:#dc8a0e:#7864fa:#b33ce8:#149bda:#c3c2c4:#878589:#d8137f:#17ad98:#dc8a0e:#7864fa:#b33ce8:#149bda:#ffffff"
gset string background_color "#2e2a31"
gset string foreground_color "#c3c2c4"
gset string bold_color "#c3c2c4"
