#!/bin/sh
# Base16 Unikitty Reversible - Shell color setup script
...
color_foreground="69/66/6b" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="69/66/6b" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 69666b # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 69666b # bold color
  printf $printf_template_custom Pj c3c2c4 # selection color
  printf $printf_template_custom Pk 69666b # selected text color
  printf $printf_template_custom Pl 69666b # cursor
