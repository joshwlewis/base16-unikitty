...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg c3c2c4 # forground
  printf $printf_template_custom Ph 2e2a31 # background
  printf $printf_template_custom Pi c3c2c4 # bold color
  printf $printf_template_custom Pj 69666b # selection color
  printf $printf_template_custom Pk c3c2c4 # selected text color
  printf $printf_template_custom Pl c3c2c4 # cursor
