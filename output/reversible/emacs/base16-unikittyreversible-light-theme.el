...
;;; base16-unikittyreversible-light-theme.el

;;; Code:

(deftheme base16-unikittyreversible-light)
...
(let ((base00 "#2e2a31")
  ...
  (custom-theme-set-faces
   'base16-unikittyreversible-light
...
(provide-theme 'base16-unikittyreversible-light)

;;; base16-unikittyreversible-light-theme.el ends here
