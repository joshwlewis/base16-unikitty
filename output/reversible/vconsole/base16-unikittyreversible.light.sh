#!/bin/sh
# Base16 Unikitty Reversible - Virtual console color setup script
...
color07="69666b" # Base 02 - Black
color08="c3c2c4" # Base 05 - Bright White
...
color15="2e2a31" # Base 00 - Bright Black
