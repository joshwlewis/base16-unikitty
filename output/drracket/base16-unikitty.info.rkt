...
;; color scheme
(define base00 #(49 38 46))
(define base01 #(77 67 74))
(define base02 #(105 97 103))
(define base03 #(134 127 132))
(define base04 #(162 157 160))
(define base05 #(191 187 189))
(define base06 #(219 217 218))
(define base07 #(248 247 247))
(define base08 #(216 4 111))
(define base09 #(214 84 7))
(define base0A #(220 138 14))
(define base0B #(15 169 148))
(define base0C #(39 158 214))
(define base0D #(127 66 245))
(define base0E #(167 23 241))
